 ...
 */
const Sidepanel = ({ activesLoaded, setActivesLoaded, email, setActiveChat, setActiveConversations, activeConversations, activeChat, addMessage, isGroupOrDm, currentRoom, groupChatName, deleteOnDisconnect }) => {
